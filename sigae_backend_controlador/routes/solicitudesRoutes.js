...
// ... imports
router.post('/post-guardar', /*authMiddleware, */proxyToSqlAuth); // RH crea la solicitud
router.get('/get-pendientes-ti', authMiddleware, proxyToSqlAuth); // TI ve qué hay por validar
router.get('/get-seguimiento/:id', authMiddleware, proxyToSqlAuth); // Para ver el Timeline/Actividades
